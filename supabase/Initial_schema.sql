/*
 * Family Allowance Tracker Database Schema
 * 
 * This schema defines the structure for the Family Allowance Tracker application.
 * It includes tables for families, members, settings, budget cycles, and daily scores.
 * 
